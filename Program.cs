    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            while (dogCharacteristic == "")
            {
                ...
                Console.WriteLine($"\r\nEnter desired dog characteristics to search for. If there are multiple, enter each item separated by commas.");
                readResult = Console.ReadLine();
                if (readResult != null)
                {
                    ...
                    foreach (string term in dogCharacteristics)
                    {
                        if (term != null && term.Trim() != "")
                        {
                            ...
                            if (dogDescription.Contains(" " + term.Trim() + " "))
                            {
                                ...
                                Console.WriteLine($"\nOur dog {ourAnimals[i, 3]} is a match for your search, {term.Trim()}!");
